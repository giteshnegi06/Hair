      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-20">
          ...
          <div className="md:col-span-3">
            ...
            <address className="w-not-italic text-xs text-luxury-text/80 space-y-3 font-light mb-6">
              <p>Dugra Colony Road, G.No-1 Vikas Nagar, Near Vijata Public School Sec 34, Karnal, Haryana 132001 India</p>
            </address>
